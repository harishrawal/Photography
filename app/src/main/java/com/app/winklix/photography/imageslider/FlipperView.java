package com.app.winklix.photography.imageslider;
...
public class FlipperView {
    ...
    public FlipperView setImageScaleType() {
    ...
    public FlipperView setOnFlipperClickListener(OnFlipperClickListener l) {
